...
public class FluentListAssertTest<E extends FluentWebElement> {
    ...
    public void should_hasText_throwsAssertionError() {
        when(fluentList.getTexts()).thenReturn(Arrays.asList("some text"));
        listAssert.hasText("no");
    }

    @Test
    public void should_hasText_satisfied() {
        when(fluentList.getTexts()).thenReturn(Arrays.asList("hello", "some text", "world"));
        assertNotNull(listAssert.hasText("text"));
    }
    ...
    @Test(expected = java.lang.AssertionError.class)
    public void should_hasNotText_throwsAssertionError() {
        when(fluentList.getTexts()).thenReturn(Arrays.asList("other text"));
        listAssert.hasNotText("text");
    }
    ...
    public void testHasSizeKo() {
        fluentList = new FluentList(Arrays.asList(mock(FluentWebElement.class)));
        listAssert = FluentLeniumAssertions.assertThat(fluentList);
